import{i as e,s as i,_ as t,n,t as a,a as s,x as o,e as r,l,r as c,b as d,c as u,d as m,p as h,f as _,g,h as b,j as p,k as v,C as f,m as $,o as y,q as w,u as S,v as x,w as M,y as I,z as k,A as O,B as C,D as z,E as A,F as T,G as N,H as B,I as E,J as P,K as H,L,M as V,N as K,O as U,S as j,P as q,Q as F,Z as R,R as D,T as G,U as J,V as Q,W,X,Y,$ as Z,a0 as ee,a1 as ie,a2 as te,a3 as ne,a4 as ae,a5 as se,a6 as oe,a7 as re,a8 as le,a9 as ce,aa as de,ab as ue,ac as me,ad as he,ae as _e,af as ge,ag as be,ah as pe,ai as ve,aj as fe,ak as $e,al as ye,am as we,an as Se,ao as xe,ap as Me,aq as Ie,ar as ke,as as Oe,at as Ce,au as ze,av as Ae,aw as Te,ax as Ne,ay as Be,az as Ee,aA as Pe,aB as He,aC as Le,aD as Ve,aE as Ke,aF as Ue,aG as je,aH as qe,aI as Fe,aJ as Re,aK as De,aL as Ge,aM as Je,aN as Qe,aO as We,aP as Xe,aQ as Ye,aR as Ze,aS as ei,aT as ii,aU as ti,aV as ni,aW as ai,aX as si,aY as oi,aZ as ri,a_ as li,a$ as ci,b0 as di,b1 as ui,b2 as mi,b3 as hi,b4 as _i,b5 as gi,b6 as bi,b7 as pi,b8 as vi,b9 as fi,ba as $i,bb as yi,bc as wi,bd as Si,be as xi,bf as Mi,bg as Ii,bh as ki,bi as Oi,bj as Ci,bk as zi,bl as Ai,bm as Ti,bn as Ni,bo as Bi,bp as Ei,bq as Pi,br as Hi,bs as Li,bt as Vi,bu as Ki,bv as Ui,bw as ji,bx as qi,by as Fi,bz as Ri,bA as Di,bB as Gi,bC as Ji,bD as Qi,bE as Wi,bF as Xi,bG as Yi,bH as Zi,bI as et,bJ as it,bK as tt,bL as nt,bM as at,bN as st,bO as ot,bP as rt,bQ as lt,bR as ct,bS as dt,bT as ut,bU as mt,bV as ht,bW as _t,bX as gt,bY as bt,bZ as pt,b_ as vt,b$ as ft,c0 as $t,c1 as yt,c2 as wt,c3 as St,c4 as xt,c5 as Mt,c6 as It,c7 as kt,c8 as Ot,c9 as Ct,ca as zt,cb as At,cc as Tt,cd as Nt,ce as Bt,cf as Et,cg as Pt,ch as Ht,ci as Lt,cj as Vt,ck as Kt,cl as Ut,cm as jt,cn as qt,co as Ft,cp as Rt,cq as Dt,cr as Gt,cs as Jt,ct as Qt,cu as Wt,cv as Xt,cw as Yt,cx as Zt,cy as en,cz as tn,cA as nn,cB as an,cC as sn,cD as on,cE as rn,cF as ln,cG as cn,cH as dn,cI as un,cJ as mn,cK as hn,cL as _n,cM as gn,cN as bn,cO as pn,cP as vn,cQ as fn,cR as $n,cS as yn,cT as wn,cU as Sn,cV as xn,cW as Mn,cX as In,cY as kn,cZ as On,c_ as Cn,c$ as zn,d0 as An,d1 as Tn,d2 as Nn,d3 as Bn,d4 as En,d5 as Pn}from"./card-3e407d5b.js";class Hn{constructor(e){this._assigning=!1,this._value=null,this._blurEventHandler=()=>{this._setAssigning(!1)},this._keydownEventHandler=e=>{e.key&&!["Control","Alt","Shift","Meta"].includes(e.key)&&(this.setValue({key:e.key,ctrl:e.ctrlKey,alt:e.altKey,shift:e.shiftKey,meta:e.metaKey}),this._setAssigning(!1))},this._host=e,this._host.addController(this)}setValue(i){e(i,this._value)||(this._value=i,this._host.requestUpdate(),this._host.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this._value}})))}getValue(){return this._value}hasValue(){return!!this._value}isAssigning(){return this._assigning}toggleAssigning(){this._setAssigning(!this._assigning)}_setAssigning(e){this._assigning=e,i(this._host,this._assigning,"assigning"),this._assigning?this._host.addEventListener("keydown",this._keydownEventHandler):this._host.removeEventListener("keydown",this._keydownEventHandler),this._host.requestUpdate()}hostConnected(){this._host.addEventListener("blur",this._blurEventHandler)}hostDisconnected(){this._host.removeEventListener("blur",this._blurEventHandler)}}let Ln=class extends s{constructor(){super(...arguments),this._controller=new Hn(this)}willUpdate(e){e.has("value")&&this._controller.setValue(this.value??null)}render(){if(!this.label)return;const e=e=>o`<div class="key">
    ...
    `}_renderInfo(e){return o` <span class="info">${e}</span>`}_getEditorCameraTitle(e,i){return"string"==typeof i?.title&&i.title||("string"==typeof i?.camera_entity?p(this.hass,i.camera_entity):"")||"object"==typeof i?.webrtc_card&&i.webrtc_card&&"string"==typeof i.webrtc_card.entity&&i.webrtc_card.entity||("object"==typeof i?.frigate&&i.frigate&&"string"==typeof i?.frigate.camera_name&&i.frigate.camera_name?v(i.frigate.camera_name):"")||"string"==typeof i?.id&&i.id||l("editor.camera")+" #"+e}_getEditorFolderTitle(e,i){return"string"==typeof i?.title&&i.title||"string"==typeof i?.id&&i.id||l("common.folder")+" #"+e}_renderViewDefaultResetMenu(){return this._putInSubmenu("view.default_reset",!0,`config.${f}.editor_label`,"mdi:restart",o`
        ...
        ${this._renderOptionSelector(S,this.hass?Vn(this.hass):[],{multiple:!0})}
    ...
    `}_renderMiniTimeline(e,i,t,n,a,s,r,c,d,u,m){return this._putInSubmenu(e,!0,"config.common.controls.timeline.editor_label","mdi:chart-gantt",o` ${this._renderOptionSelector(i,this._miniTimelineModes,{label:l("config.common.controls.timeline.mode")})}
      ...
      ${this._renderOptionSelector(t,this.hass?Vn(this.hass):[],{label:l("config.common.image.entity")})}
    ...
    `}_renderFolder(e,i,t){const n={submenu:!0,selected:this._expandedMenus[Un]===i},a=[{value:"",label:""},{value:"ha",label:l("config.folders.types.ha")}];return o` <div class="${r(n)}">
      <div
        class="submenu-header"
        @click=${this._toggleMenu}
        .domain=${Un}
      ...
      ${this._expandedMenus[Un]===i?o` <div class="values">
            ${this._renderArrayManagementControls(te,i,Un,t)}
            ${this._renderOptionSelector(ne(kt,i),a)}
            ${this._renderStringInput(ne(Ot,i))}
            ${this._renderIconSelector(ne(Ct,i),{label:l("config.folders.icon")})}
            ${this._renderStringInput(ne(zt,i))}
      ...
      <div class="${r(c)}">
        ...
        ${this._expandedMenus[Kn]===i?o` <div class="values">
              ${this._renderArrayManagementControls(re,i,Kn,n)}
              ${this._renderEntitySelector(ne(Tt,i),"camera")}
              ${this._renderOptionSelector(ne(Nt,i),a)}
              ${this._renderStringInput(ne(Bt,i))}
              ${this._renderIconSelector(ne(Et,i),{label:l("config.cameras.icon")})}
              ${this._renderStringInput(ne(Pt,i))}
              ${this._renderSwitch(ne(Ht,i),this._defaults.cameras.always_error_if_entity_unavailable)}
              ${this._putInSubmenu("cameras.engine",!0,"config.cameras.engines.editor_label","mdi:engine",o`${this._putInSubmenu("cameras.frigate",i,"config.cameras.frigate.editor_label","frigate",o`
                    ${this._renderStringInput(ne(Lt,i))}
                    ${this._renderStringInput(ne(Vt,i))}
                    ${this._renderOptionSelector(ne(Kt,i),[],{multiple:!0,label:l("config.cameras.frigate.labels")})}
                    ${this._renderOptionSelector(ne(Ut,i),[],{multiple:!0,label:l("config.cameras.frigate.zones")})}
                    ${this._renderStringInput(ne(jt,i))}
                  `)}
                ${this._putInSubmenu("cameras.motioneye",i,"config.cameras.motioneye.editor_label","motioneye",o` ${this._renderStringInput(ne(qt,i))}
                  ${this._renderStringInput(ne(Ft,i))}
                  ${this._renderStringInput(ne(Rt,i))}
                  ${this._renderStringInput(ne(Dt,i))}
                  ${this._renderStringInput(ne(Gt,i))}`)}
                ${this._putInSubmenu("cameras.reolink",i,"config.cameras.reolink.editor_label","reolink",o` ${this._renderStringInput(ne(Jt,i))}
                  ${this._renderOptionSelector(ne(Qt,i),this._reolinkMediaResolution,{label:l("config.cameras.reolink.media_resolution.editor_label")})}`)}`)}
              ${this._putInSubmenu("cameras.live_provider",!0,"config.cameras.live_provider_options.editor_label","mdi:cctv",o` ${this._putInSubmenu("cameras.go2rtc",i,"config.cameras.go2rtc.editor_label","mdi:alpha-g-circle",o`${this._renderOptionSelector(ne(Wt,i),this._go2rtcModes,{multiple:!0,label:l("config.cameras.go2rtc.modes.editor_label")})}
                  ${this._renderStringInput(ne(Xt,i))}
                  ${this._renderStringInput(ne(Yt,i))} `)}
                ${this._putInSubmenu("cameras.image",!0,"config.cameras.image.editor_label","mdi:image",this._renderImageOptions(ne(Zt,i),ne(en,i),ne(tn,i),ne(nn,i),ne(an,i)))}
                ${this._putInSubmenu("cameras.webrtc_card",i,"config.cameras.webrtc_card.editor_label","mdi:webrtc",o`${this._renderEntitySelector(ne(sn,i),"camera")}
                  ${this._renderStringInput(ne(on,i))}`)}`)}
              ${this._putInSubmenu("cameras.dependencies",i,"config.cameras.dependencies.editor_label","mdi:graph",o` ${this._renderSwitch(ne(rn,i),this._defaults.cameras.dependencies.all_cameras)}
                ${this._renderOptionSelector(ne(ln,i),s,{multiple:!0})}`)}
              ${this._putInSubmenu("cameras.triggers",i,"config.cameras.triggers.editor_label","mdi:magnify-scan",o`
                  ${this._renderSwitch(ne(cn,i),this._defaults.cameras.triggers.occupancy)}
                  ${this._renderSwitch(ne(dn,i),this._defaults.cameras.triggers.motion)}
                  ${this._renderOptionSelector(ne(un,i),t,{multiple:!0})}
                  ${this._renderOptionSelector(ne(mn,i),this._triggersEvents,{multiple:!0,label:l("config.cameras.triggers.events.editor_label")})}
                `)}
              ${this._putInSubmenu("cameras.cast",i,"config.cameras.cast.editor_label","mdi:cast",o`
                  ${this._renderOptionSelector(ne(hn,i),this._castMethods)}
                  ${this._renderStringInput(ne(_n,i))}
                  ${this._renderStringInput(ne(gn,i))}
                `)}
              ${this._putInSubmenu("cameras.dimensions",i,"config.cameras.dimensions.editor_label","mdi:aspect-ratio",o`
                  ${this._renderStringInput(ne(bn,i))}
                  ${this._renderOptionSelector(ne(pn,i),this._rotations)}
                  ${this._renderMediaLayout("cameras.dimensions.layout","config.cameras.dimensions.layout.editor_label",ne(vn,i),ne(fn,i),ne($n,i),ne(yn,i),ne(wn,i),ne(Sn,i),ne(xn,i),ne(Mn,i),ne(In,i),ne(kn,i))}
                `)}
              ${this._putInSubmenu("cameras.capabilities",i,"config.cameras.capabilities.editor_label","mdi:cog-stop",o`
                  ${this._renderOptionSelector(ne(On,i),this._capabilities,{multiple:!0})}
                  ${this._renderOptionSelector(ne(Cn,i),this._capabilities,{multiple:!0})}
                `)}
              ${this._putInSubmenu("cameras.proxy",i,"config.cameras.proxy.editor_label","mdi:arrow-decision",o`
                  ${this._renderOptionSelector(ne(zn,i),this._proxyModes,{label:l("config.cameras.proxy.live")})}
                  ${this._renderOptionSelector(ne(An,i),this._proxyModes,{label:l("config.cameras.proxy.media")})}
                  ${this._renderSwitch(ne(Tn,i),this._defaults.cameras.proxy.dynamic)}
                  ${this._renderOptionSelector(ne(Nn,i),this._proxySSLVerification,{label:l("config.cameras.proxy.ssl_verification.editor_label")})}
                  ${this._renderOptionSelector(ne(Bn,i),this._proxySSLCiphers,{label:l("config.cameras.proxy.ssl_ciphers.editor_label")})}
                `)}
            </div>`:""}
      </div>
    ...
    `}_updateConfig(e){this._config=e,le(this,"config-changed",{config:this._config})}render(){if(!this.hass||!this._config)return o``;const e=Vn(this.hass),i=b(this._config,re)||[],t=b(this._config,te)||[];return o`
      ...
      <div class="card-config">
        ...
        ${"cameras"===this._expandedMenus[jn]?o`
              <div class="values">
        ...
        ${"profiles"===this._expandedMenus[jn]?o` <div class="values">
        ...
        ${"status_bar"===this._expandedMenus[jn]?o`
              <div class="values">
        ...
        ${"live"===this._expandedMenus[jn]?o`
              <div class="values">
                ...
                ${this._putInSubmenu("live.controls",!0,"config.live.controls.editor_label","mdi:gamepad",o`
                    ...
                    ${this._renderSwitch(qe,this._defaults.live.controls.wheel,{label:l("config.common.controls.wheel")})}
                    ${this._renderNextPreviousControls("live.controls.next_previous",Fe,Re,{allowIcons:!0})}
                    ${this._renderThumbnailsControls("live.controls.thumbnails",De,Ge,Je,Qe,We,this._defaults.live.controls.thumbnails,{configPathMediaType:Xe,configPathEventsMediaType:Ye,configPathMode:Ze})}
                    ${this._renderMiniTimeline("live.controls.timeline",ei,ii,ti,ni,ai,si,oi,this._defaults.live.controls.timeline.show_recordings,this._defaults.live.controls.timeline.format["24h"],ri)}
                    ${this._putInSubmenu("live.controls.ptz",!0,"config.live.controls.ptz.editor_label","mdi:pan",o`
                        ...
                        ${this._renderOptionSelector(ci,this._ptzPositions)}
                        ${this._renderOptionSelector(di,this._ptzOrientations)}
                        ${this._renderSwitch(ui,this._defaults.live.controls.ptz.hide_pan_tilt,{label:l("config.live.controls.ptz.hide_pan_tilt")})}
                        ${this._renderSwitch(mi,this._defaults.live.controls.ptz.hide_pan_tilt,{label:l("config.live.controls.ptz.hide_zoom")})}
                        ${this._renderSwitch(hi,this._defaults.live.controls.ptz.hide_home,{label:l("config.live.controls.ptz.hide_home")})}
                      `)}
                  `)}
                ${this._putInSubmenu("live.microphone",!0,"config.live.microphone.editor_label","mdi:microphone",o`
                    ${this._renderNumberInput(_i)}
                    ${this._renderSwitch(gi,this._defaults.live.microphone.always_connected)}
                    ${this._renderNumberInput(bi)}
                  `)}
              </div>
            `:""}
        ${this._renderOptionSetHeader("folders")}
        ${"folders"===this._expandedMenus[jn]?o` <div class="values">
              ${t.map(((e,i)=>this._renderFolder(t,i)))}
              ${this._renderFolder(t,t.length,!0)}
            </div>`:""}
        ${this._renderOptionSetHeader("media_gallery")}
        ${"media_gallery"===this._expandedMenus[jn]?o` <div class="values">
              ${this._renderThumbnailsControls("media_gallery.controls.thumbnails",pi,vi,fi,$i,yi,this._defaults.media_gallery.controls.thumbnails)}
              ${this._renderFilterControls("media_gallery.controls.filter",wi)}
            </div>`:""}
        ${this._renderOptionSetHeader("media_viewer")}
        ${"media_viewer"===this._expandedMenus[jn]?o` <div class="values">
              ${this._renderOptionSelector(Si,this._mediaActionPositiveConditions,{multiple:!0})}
              ${this._renderOptionSelector(xi,this._mediaActionNegativeConditions,{multiple:!0})}
              ${this._renderOptionSelector(Mi,this._mediaActionNegativeConditions,{multiple:!0})}
              ${this._renderOptionSelector(Ii,this._mediaActionPositiveConditions,{multiple:!0})}
              ${this._renderSwitch(ki,this._defaults.media_viewer.draggable)}
              ${this._renderSwitch(Oi,this._defaults.media_viewer.zoomable)}
              ${this._renderSwitch(Ci,this._defaults.media_viewer.lazy_load)}
              ${this._renderOptionSelector(zi,this._transitionEffects)}
              ${this._renderSwitch(Ai,this._defaults.media_viewer.snapshot_click_plays_clip)}
              ${this._renderViewDisplay("media_viewer.display",Ti,Ni,Bi,Ei,Pi)}
              ${this._putInSubmenu("media_viewer.controls",!0,"config.media_viewer.controls.editor_label","mdi:gamepad",o`
                  ${this._renderSwitch(Hi,this._defaults.media_viewer.controls.builtin,{label:l("config.common.controls.builtin")})}
                  ${this._renderSwitch(Li,this._defaults.media_viewer.controls.wheel,{label:l("config.common.controls.wheel")})}
                  ${this._renderNextPreviousControls("media_viewer.controls.next_previous",Vi,Ki,{allowThumbnails:!0})}
                  ${this._renderThumbnailsControls("media_viewer.controls.thumbnails",Ui,ji,qi,Fi,Ri,this._defaults.media_viewer.controls.thumbnails,{configPathMode:Di})}
                  ${this._renderMiniTimeline("media_viewer.controls.timeline",Gi,Ji,Qi,Wi,Xi,Yi,Zi,this._defaults.media_viewer.controls.timeline.show_recordings,this._defaults.media_viewer.controls.timeline.format["24h"],et)}
                `)}
            </div>`:""}
        ${this._renderOptionSetHeader("image")}
        ${"image"===this._expandedMenus[jn]?o` <div class="values">
              ${this._renderImageOptions(it,tt,nt,at,st)}
            </div>`:""}
        ${this._renderOptionSetHeader("timeline")}
        ${"timeline"===this._expandedMenus[jn]?o` <div class="values">
              ${this._renderTimelineCoreControls("timeline.format",G,J,Q,W,X,ot,this._defaults.timeline.show_recordings,this._defaults.timeline.format["24h"])}
              ${this._renderThumbnailsControls("timeline.controls.thumbnails",rt,lt,ct,dt,ut,this._defaults.timeline.controls.thumbnails,{configPathMode:mt})}
            </div>`:""}
        ${this._renderOptionSetHeader("dimensions")}
        ${"dimensions"===this._expandedMenus[jn]?o` <div class="values">
              ${this._renderOptionSelector(ht,this._aspectRatioModes)}
              ${this._renderStringInput(_t)}
              ${this._renderStringInput(gt)}
            </div>`:""}
        ${this._renderOptionSetHeader("performance","low"===b(this._config,En)?"warning":void 0)}
        ${"performance"===this._expandedMenus[jn]?o` <div class="values">
              ${"low"===b(this._config,En)?this._renderInfo(l("config.performance.warning")):o``}
              ${this._putInSubmenu("performance.features",!0,"config.performance.features.editor_label","mdi:feature-search",o`
                  ${this._renderSwitch(bt,this._defaults.performance.features.card_loading_indicator)}
                  ${this._renderSwitch(pt,this._defaults.performance.features.card_loading_effects)}
                  ${this._renderSwitch(vt,this._defaults.performance.features.animated_progress_indicator)}
                  ${this._renderNumberInput(ft,{max:$t})}
                  ${this._renderNumberInput(yt,{min:1})}
                `)}
              ${this._putInSubmenu("performance.style",!0,"config.performance.style.editor_label","mdi:palette-swatch-variant",o`
                  ${this._renderSwitch(wt,this._defaults.performance.style.border_radius)}
                  ${this._renderSwitch(St,this._defaults.performance.style.box_shadow)}
                `)}
            </div>`:""}
        ${this._renderOptionSetHeader("remote_control")}
        ${"remote_control"===this._expandedMenus[jn]?o` <div class="values">
              ${this._putInSubmenu("remote_control.entities",!0,"config.remote_control.entities.editor_label","mdi:devices",o`
                  ${this._renderEntitySelector(xt,"input_select")}
                `)}
            </div>`:""}
        ${void 0!==this._config.overrides?o` ${this._renderOptionSetHeader("overrides")}
            ${"overrides"===this._expandedMenus[jn]?o` <div class="values">
                  ${this._renderInfo(l("config.overrides.info"))}
                </div>`:""}`:o``}
      </div>
    `}_closeMenu(e){delete this._expandedMenus[e],this.requestUpdate()}_openMenu(e,i){this._expandedMenus[e]=i,this.requestUpdate()}_toggleMenu(e){if(e&&e.target){const i=e.target.domain,t=e.target.key;this._expandedMenus[i]===t?this._closeMenu(i):this._openMenu(i,t)}}_valueChangedHandler(e,i){if(!this._config||!this.hass)return;let t;if(i.detail&&void 0!==i.detail.value&&(t=i.detail.value,"string"==typeof t&&(t=t.trim())),b(this._config,e)===t)return;const n=u(this._config);""===t||void 0===t?Mt(n,e):It(n,e,t),this._updateConfig(n)}static get styles(){return c('ha-icon-button {\n  color: var(--advanced-camera-card-button-color);\n  background-color: var(--advanced-camera-card-button-background);\n  border-radius: 50%;\n  padding: 0px;\n  margin: 3px;\n  --ha-icon-display: block;\n  /* Buttons can always be clicked */\n  pointer-events: auto;\n}\n\n.option {\n  padding: 4px 4px;\n  cursor: pointer;\n}\n\n.option.option-overrides .title {\n  color: var(--warning-color);\n}\n\n.row {\n  display: flex;\n  margin-bottom: -14px;\n  pointer-events: none;\n}\n\n.title {\n  padding-left: 16px;\n  margin-top: -6px;\n  pointer-events: none;\n}\n\n.title.warning {\n  color: var(--warning-color);\n}\n\n.secondary {\n  padding-left: 40px;\n  color: var(--secondary-text-color);\n  pointer-events: none;\n}\n\n.values {\n  background: var(--secondary-background-color);\n  display: grid;\n}\n\n.values + .option,\n.submenu + .option {\n  margin-top: 10px;\n}\n\ndiv.upgrade {\n  width: auto;\n  border: 1px dotted var(--primary-color);\n  margin: 10px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n\ndiv.upgrade span {\n  padding: 10px;\n}\n\n.submenu-header {\n  display: flex;\n  padding: 10px;\n  cursor: pointer;\n}\n\n.submenu.selected > .submenu-header {\n  background-color: var(--primary-color);\n  color: var(--primary-text-color);\n}\n\n.submenu-header * {\n  flex-basis: auto;\n  pointer-events: none;\n}\n\n.submenu-header .new {\n  font-style: italic;\n}\n\n.submenu:not(.selected) > .submenu-header .new {\n  color: var(--secondary-text-color, "black");\n}\n\n.submenu-header advanced-camera-card-icon {\n  margin-right: 15px;\n}\n\n.submenu.selected {\n  border: 1px solid var(--primary-color);\n}\n\n.submenu {\n  width: calc(100% - 20px);\n  margin-left: auto;\n  margin-right: auto;\n  margin-bottom: 10px;\n}\n\n.submenu:first-child,\n:not(.submenu) + .submenu {\n  margin-top: 10px;\n}\n\n.submenu .controls {\n  display: inline-block;\n  margin-left: auto;\n  margin-right: 0px;\n  margin-bottom: 5px;\n}\n\n.submenu .controls ha-icon-button {\n  --mdc-icon-button-size: 32px;\n  --mdc-icon-size: calc(var(--mdc-icon-button-size) / 2);\n}\n\nspan.info {\n  padding: 10px;\n}\n\nha-selector {\n  padding: 10px;\n  border: 1px solid var(--divider-color);\n}\n\nadvanced-camera-card-message::part(icon) {\n  color: var(--primary-color);\n}')}};t([n({attribute:!1})],Fn.prototype,"hass",void 0),t([d()],Fn.prototype,"_config",void 0),t([d()],Fn.prototype,"_defaults",void 0),t([d()],Fn.prototype,"_expandedMenus",void 0),Fn=t([a("advanced-camera-card-editor")],Fn);export{Fn as AdvancedCameraCardEditor};
